...
export default function PrivacyPolicy() {
  return (
    <div>
        <p>
        Privacy Policy Last updated: June 07, 2020 This Privacy Policy
          ...
          purposes of this Privacy Policy: You means the individual accessing or
          using the Service, or the company, or other legal entity on behalf of
          which such individual is accessing or using the Service, as
          applicable. Company (referred to as either "the Company", "We", "Us"
          or "Our" in this Agreement) refers to Jo The Fish. Affiliate means an
          entity that controls, is controlled by or is under common control with
          a party, where "control" means ownership of 50% or more of the shares,
          equity interest or other securities entitled to vote for election of
          directors or other managing authority. Account means a unique account
          created for You to access our Service or parts of our Service. Website
          refers to Jo The Fish, accessible from https://jothefish.com Service
          refers to the Website. Country refers to: United Kingdom Service
          ...
          or create an account to use the Service. Personal Data is any
          information that relates to an identified or identifiable individual.
          Cookies are small files that are placed on Your computer, mobile
          device or any other device by a website, containing the details of
          Your browsing history on that website among its many uses. Device
          means any device that can access the Service such as a computer, a
          cellphone or a digital tablet. Usage Data refers to data collected
          ...
          visit). Collecting and Using Your Personal Data Types of Data
          ...
          code, City Usage Data Usage Data Usage Data is collected automatically
          when using the Service. Usage Data may include information such as
          ...
          or through a mobile device. Tracking Technologies and Cookies We use
          ...
          as You close your web browser. Learn more about cookies: All About
          Cookies. We use both session and persistent Cookies for the purposes
          set out below: Necessary / Essential Cookies Type: Session Cookies
          ...
          to re-enter your preferences every time You use the Website. For more
          ...
          the Service that are available to You as a registered user. For the
          ...
          may share your personal information in the following situations: With
          ...
          profile. Retention of Your Personal Data The Company will retain Your
          ...
          its absolute security. Your California Privacy Rights (California's
          Shine the Light law) Under California Civil Code Section 1798
          (California's Shine the Light law), California residents with an
          established business relationship with us can request information once
          a year about sharing their Personal Data with third parties for the
          third parties' direct marketing purposes. If you'd like to request
          more information under the California Shine the Light law, and if you
          are a California resident, You can contact Us using the contact
          information provided below. California Privacy Rights for Minor Users
          (California Business and Professions Code Section 22581) California
          Business and Professions Code section 22581 allow California residents
          under the age of 18 who are registered users of online sites, services
          or applications to request and obtain removal of content or
          information they have publicly posted. To request removal of such
          data, and if you are a California resident, You can contact Us using
          ...
          certain circumstances. Links to Other Websites Our Service may contain
          ...
          effective when they are posted on this page. Contact Us If you have
          any questions about this Privacy Policy, You can contact us: By email:
          info@projectdoright.com By visiting this page on our website:
          http://jothefish.com/#contact
        </p>
    </div>
  );
}
